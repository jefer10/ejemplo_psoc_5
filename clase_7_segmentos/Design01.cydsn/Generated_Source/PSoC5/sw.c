...
void sw_SetDriveMode(uint8 mode)
{
	...
	CyPins_SetPinDriveMode(sw_3, mode);
	CyPins_SetPinDriveMode(sw_4, mode);
	CyPins_SetPinDriveMode(sw_5, mode);
	CyPins_SetPinDriveMode(sw_6, mode);
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    void sw_SetInterruptMode(uint16 position, uint16 mode)
    {
		...
		if((position & sw_3_INTR) != 0u) 
		{ 
			 sw_3_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & sw_4_INTR) != 0u) 
		{ 
			 sw_4_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & sw_5_INTR) != 0u) 
		{ 
			 sw_5_INTTYPE_REG = (uint8)mode; 
		} 
		if((position & sw_6_INTR) != 0u) 
		{ 
			 sw_6_INTTYPE_REG = (uint8)mode; 
		}
    }
