// ======================================================================
// lcdClase2.v generated from TopDesign.cysch
// 08/22/2018 at 12:02
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("638c458c-bb95-4ae9-9574-47af7a8a9441/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [7:0] tmpOE__swi_net;
	wire [7:0] tmpFB_7__swi_net;
	wire [7:0] tmpIO_7__swi_net;
	...
	cy_psoc3_pins_v1_10
		...
		swi
		 (.oe(tmpOE__swi_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__swi_net[7:0]}),
		  .io({tmpIO_7__swi_net[7:0]}),
	...
	assign tmpOE__swi_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
