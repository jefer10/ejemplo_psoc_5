...
static LCD_C_BACKUP_STRUCT LCD_C_backup;


/*******************************************************************************
* Function Name: LCD_C_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: LCD_C_RestoreConfig
********************************************************************************
*
* Summary:
*  Does nothing, provided for consistency.
...
{
    LCD_C_backup.enableState = LCD_C_enableState;
    LCD_C_SaveConfig();
    LCD_C_Stop();
}
...
*
* Parameters:
*  LCD_C_enableState - Global variable.
*
* Return:
...
void LCD_C_Wakeup(void) 
{
    ...
    if(LCD_C_backup.enableState == 1u)
    {
        LCD_C_Enable();
    }
}
