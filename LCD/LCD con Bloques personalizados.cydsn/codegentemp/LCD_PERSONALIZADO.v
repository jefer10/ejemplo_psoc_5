// ======================================================================
// LCD_PERSONALIZADO.v generated from TopDesign.cysch
// 08/24/2018 at 11:48
...
// CharLCD_v2_20(ConversionRoutines=false, CUSTOM0="0,1,3,F,1F,1E,1E,3,", CUSTOM1="F,1D,19,19,1F,F,F,1C,", CUSTOM2="1C,16,13,13,1F,1E,1E,3,", CUSTOM3="0,0,0,1C,1E,F,F,18,", CUSTOM4="0,0,0,0,0,0,0,0,", CUSTOM5="0,0,0,0,0,0,0,0,", CUSTOM6="0,0,0,0,0,0,0,0,", CUSTOM7="0,0,0,0,0,0,0,0,", CustomCharacterSet=3, TypeReplacementString=uint8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=CharLCD_v2_20, CY_CONFIG_TITLE=LCD, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD, CY_INSTANCE_SHORT_NAME=LCD, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LCD, )
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("6512524f-22c7-4d81-a85b-5f0dafea6db5/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [3:0] tmpOE__sw_net;
	wire [3:0] tmpFB_3__sw_net;
	wire [3:0] tmpIO_3__sw_net;
	...
	cy_psoc3_pins_v1_10
		...
		sw
		 (.oe(tmpOE__sw_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__sw_net[3:0]}),
		  .io({tmpIO_3__sw_net[3:0]}),
	...
	assign tmpOE__sw_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
