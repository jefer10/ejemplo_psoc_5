...
/* Interrupt Registers */
	...
	#define swi_4_INTTYPE_REG 		(* (reg8 *) swi__4__INTTYPE)
	#define swi_5_INTTYPE_REG 		(* (reg8 *) swi__5__INTTYPE)
	#define swi_6_INTTYPE_REG 		(* (reg8 *) swi__6__INTTYPE)
	#define swi_7_INTTYPE_REG 		(* (reg8 *) swi__7__INTTYPE)
#endif /* (swi__INTSTAT) */
