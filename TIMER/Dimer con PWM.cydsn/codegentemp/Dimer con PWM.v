// ======================================================================
// Dimer con PWM.v generated from TopDesign.cysch
// 09/18/2018 at 11:40
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0a634f49-22e3-4153-877b-031c440d1bf5/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_min1_net;
	wire [0:0] tmpFB_0__Pin_min1_net;
	wire [0:0] tmpIO_0__Pin_min1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_min1_net;
	electrical [0:0] tmpSIOVREF__Pin_min1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_min1
		 (.oe(tmpOE__Pin_min1_net),
		  .y({Net_41}),
		  .fb({tmpFB_0__Pin_min1_net[0:0]}),
		  .io({tmpIO_0__Pin_min1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_min1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_min1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_min1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("35f2a2ba-1660-48cf-82fe-2d52f8ac6dd3"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("400000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("6f0be219-9fe7-45c6-8ace-8d1b1dd0484c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000000"),
		  .is_direct(0),
	...
	wire [1:0] tmpOE__SWI_net;
	wire [1:0] tmpFB_1__SWI_net;
	wire [1:0] tmpIO_1__SWI_net;
	...
	cy_psoc3_pins_v1_10
		...
		SWI
		 (.oe(tmpOE__SWI_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__SWI_net[1:0]}),
		  .io({tmpIO_1__SWI_net[1:0]}),
		  .siovref(tmpSIOVREF__SWI_net),
		  .interrupt({Net_643}),
		  .annotation({Net_645, Net_642}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

	wire [0:0] tmpOE__Pin_min2_net;
	wire [0:0] tmpFB_0__Pin_min2_net;
	wire [0:0] tmpIO_0__Pin_min2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_min2_net;
	electrical [0:0] tmpSIOVREF__Pin_min2_net;

	cy_psoc3_pins_v1_10
		#(.id("c3020af1-6f33-4c27-b4ed-d3829b1ae340"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_min2
		 (.oe(tmpOE__Pin_min2_net),
		  .y({Net_610}),
		  .fb({tmpFB_0__Pin_min2_net[0:0]}),
		  .io({tmpIO_0__Pin_min2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_min2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_min2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_min2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
