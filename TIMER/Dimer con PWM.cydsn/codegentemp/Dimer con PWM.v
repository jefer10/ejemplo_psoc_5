...
module top ;
    ...
    assign Net_1040 = 1'h0;

	wire [0:0] tmpOE__Pin_hora1_net;
	wire [0:0] tmpFB_0__Pin_hora1_net;
	wire [0:0] tmpIO_0__Pin_hora1_net;
	wire [0:0] tmpINTERRUPT_0__Pin_hora1_net;
	electrical [0:0] tmpSIOVREF__Pin_hora1_net;

	cy_psoc3_pins_v1_10
		#(.id("b29a08bd-dad4-4c4e-bb45-004af68bfbc8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_hora1
		 (.oe(tmpOE__Pin_hora1_net),
		  .y({Net_1064}),
		  .fb({tmpFB_0__Pin_hora1_net[0:0]}),
		  .io({tmpIO_0__Pin_hora1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_hora1_net),
		  .interrupt({tmpINTERRUPT_0__Pin_hora1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_hora1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_hora2_net;
	wire [0:0] tmpFB_0__Pin_hora2_net;
	wire [0:0] tmpIO_0__Pin_hora2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_hora2_net;
	electrical [0:0] tmpSIOVREF__Pin_hora2_net;

	cy_psoc3_pins_v1_10
		#(.id("8f3dbe2c-f3bf-49b8-a804-49cf0d703d48"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_hora2
		 (.oe(tmpOE__Pin_hora2_net),
		  .y({Net_1086}),
		  .fb({tmpFB_0__Pin_hora2_net[0:0]}),
		  .io({tmpIO_0__Pin_hora2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_hora2_net),
		  .interrupt({tmpINTERRUPT_0__Pin_hora2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_hora2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
