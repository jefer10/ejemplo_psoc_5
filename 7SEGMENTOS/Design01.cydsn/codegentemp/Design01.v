...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bLED_PWM_v1_10"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bLED_PWM_v1_10\bLED_PWM_v1_10.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bLED_PWM_v1_10"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.2\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bLED_PWM_v1_10\bLED_PWM_v1_10.v"
`endif
...
// LED_Driver_v1_10(BrightnessCtrl=1, ClkSource=0, CommonDrive=1, InternalClockFrequency=102400, NumCom=2, NumSeg=7, RefreshRate=200, SegmentDrive=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=LED_Driver_v1_10, CY_CONFIG_TITLE=display, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=display, CY_INSTANCE_SHORT_NAME=display, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=display, )
...
module top ;
	...
	wire [6:0] tmpOE__sw_net;
	wire [6:0] tmpIO_6__sw_net;
	wire [0:0] tmpINTERRUPT_0__sw_net;
	electrical [0:0] tmpSIOVREF__sw_net;

	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  .drive_mode(21'b010_010_010_010_010_010_010),
		  ...
		  .spanning(0),
		  .use_annotation(7'b1_1_1_1_1_1_1),
		...
		sw
		 (.oe(tmpOE__sw_net),
		  .y({7'b0}),
		  .fb({Net_11, Net_10, Net_9, Net_8, Net_7, Net_6, Net_4}),
		  .io({tmpIO_6__sw_net[6:0]}),
		  .siovref(tmpSIOVREF__sw_net),
		  .interrupt({tmpINTERRUPT_0__sw_net[0:0]}),
		  .annotation({Net_18, Net_17, Net_16, Net_15, Net_15, Net_13, Net_12}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sw_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{7'b1111111} : {7'b1111111};
	...
	cy_psoc3_pins_v1_10
		#(.id("3cf68df0-4833-407c-a3fb-57ec3ecfa895"),
	...
	wire [1:0] tmpOE__Com_1_net;
	wire [1:0] tmpFB_1__Com_1_net;
	wire [1:0] tmpIO_1__Com_1_net;
	wire [0:0] tmpINTERRUPT_0__Com_1_net;
	electrical [0:0] tmpSIOVREF__Com_1_net;

	cy_psoc3_pins_v1_10
		#(.id("aa4752c6-49d9-4dd4-ac3c-5208a4fe40a5"),
		...
		Com_1
		 (.oe(tmpOE__Com_1_net),
		  .y({Net_37[1:0]}),
		  .fb({tmpFB_1__Com_1_net[1:0]}),
		  .io({tmpIO_1__Com_1_net[1:0]}),
	...
	assign tmpOE__Com_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

    LED_Driver_v1_10_0 display (
        .clock(1'b0),
        .seg(Net_36[6:0]),
        .com(Net_37[1:0]));
