...
/* Interrupt Registers */
	...
	#define sw_3_INTTYPE_REG 		(* (reg8 *) sw__3__INTTYPE)
	#define sw_4_INTTYPE_REG 		(* (reg8 *) sw__4__INTTYPE)
	#define sw_5_INTTYPE_REG 		(* (reg8 *) sw__5__INTTYPE)
	#define sw_6_INTTYPE_REG 		(* (reg8 *) sw__6__INTTYPE)
#endif /* (sw__INTSTAT) */
